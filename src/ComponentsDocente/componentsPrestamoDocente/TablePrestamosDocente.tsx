...
import DetalleActivoDocente from '../componentsMenuDocente/DetalleActivoDocente';
...
const TableComponentDocente: React.FC = () => {
  ...
  // Filtrado de activos según filtros
  ...
  // Ordenamos por `numPlaca` (el campo que coincide con "No. Identificador").
  ...
  return (
    <div className="w-full flex justify-center py-6">
      ...
      >
        {/* Filtros y selector de ubicación */}
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mt-8">
          {/* Izquierda: Mostrar X entradas y Orden */}
      ...
      {isModalOpen && selectedActivo && (
        <DetalleActivoDocente activo={selectedActivo} onClose={closeModal} />
      )}
    </div>
  );
};
